...
#   - Zeigt bei GET das Registrierungsformular.
#   - Verarbeitet bei POST das Formular und legt Benutzer an.
# --------------------------------------------------
...
def change_email():
    ...
    if 'new_email' in request.form.keys():
        ...
        if Users.query.filter_by(email=request.form['new_email']).first():
            ...
            return render_template('twofa_verify.html', action='account.change_email')
...
# --------------------------------------------------
# Route: /account/change_2fa/<method>
# Zweck:
...
# --------------------------------------------------
@blueprint.route('/change_2fa/<method>')
@login_required
@twofa_required
...
# --------------------------------------------------
# Route: /account/download_backup_codes
# Zweck:
...
# --------------------------------------------------
@blueprint.route('/download_backup_codes')
@login_required
@twofa_required
